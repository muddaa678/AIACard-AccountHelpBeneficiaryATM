...
const FrameComponent1: NextPage<FrameComponent1Type> = ({ className = "" }) => {
  return (
    <div
      className={`w-[14.75rem] flex flex-col items-start justify-start pt-[10.625rem] px-[1.062rem] pb-[23.937rem] box-border relative gap-[8.875rem] text-left text-[0.75rem] text-white font-montserrat mq450:pt-[4.438rem] mq450:pb-[10.125rem] mq450:box-border mq950:hidden mq950:pt-[6.875rem] mq950:pb-[15.563rem] mq950:box-border ${className}`}
    >
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[1.562rem]">
          ...
          <button className="cursor-pointer [border:none] p-[0.25rem] bg-goldenrod self-stretch rounded-3xs flex flex-row items-start justify-start gap-[0.812rem] z-[1]">
            ...
            <div className="flex flex-col items-start justify-start pt-[0.687rem] px-[0rem] pb-[0rem]">
              <b className="relative text-[0.75rem] inline-block font-montserrat text-black text-left min-w-[4.563rem] z-[2]">
                Need Help?
              </b>
            </div>
          </button>

...
const FrameComponent2: NextPage<FrameComponent2Type> = ({ className = "" }) => {
  return (
    <div
      className={`w-[14.75rem] flex flex-col items-start justify-start pt-[10.625rem] px-[1.062rem] pb-[23.937rem] box-border relative gap-[9.812rem] text-left text-[0.75rem] text-white font-montserrat mq925:hidden mq925:pt-[6.875rem] mq925:pb-[15.563rem] mq925:box-border mq450:pt-[4.438rem] mq450:pb-[10.125rem] mq450:box-border ${className}`}
    >
      <div className="self-stretch flex flex-col items-start justify-start gap-[2.487rem]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[1.562rem]">
          ...
          <button className="cursor-pointer [border:none] p-[0.25rem] bg-goldenrod self-stretch rounded-3xs flex flex-row items-start justify-start gap-[0.875rem] z-[1]">
            <div className="h-[2.813rem] w-[12.375rem] relative rounded-3xs bg-goldenrod hidden" />
            <div className="h-[2.313rem] w-[2.313rem] relative">
              <div className="absolute top-[0rem] left-[0rem] rounded-[50%] bg-gray w-full h-full z-[2]" />
              <img
                className="absolute top-[0.688rem] left-[0.813rem] w-[0.688rem] h-[1rem] object-cover z-[3]"
                alt=""
                src="/muddashir-siddique-22-1@2x.png"
              />
            </div>
            <div className="flex flex-col items-start justify-start pt-[0.687rem] px-[0rem] pb-[0rem]">
              <b className="relative text-[0.75rem] inline-block font-montserrat text-black text-left min-w-[4.938rem] z-[2]">
                ATM Locator
              </b>
            </div>
          </button>
          <div className="self-stretch flex flex-row items-start justify-end pt-[0rem] px-[2.187rem] pb-[0.937rem]">
